...
const TABLES: { name: string; userCol: string }[] = [
  ...
  // MB-13 · Pieza 5.2: los nombres de tabla de ciclo/fitness/ayuno/suplementos
  // eran fantasma (cycle_logs, user_routines, workout_logs, fasting_sessions,
  // supplements no existen) y caían en _skipped_tables en silencio. Nombres
  // reales + las tablas sensibles que faltaban (emociones, mente, expediente).
  { name: 'cycle_daily_logs', userCol: 'user_id' },
  { name: 'cycle_periods', userCol: 'user_id' },
  { name: 'cycle_symptoms', userCol: 'user_id' },
  ...
  { name: 'scheduled_routines', userCol: 'user_id' },
  { name: 'workout_sessions', userCol: 'user_id' },
  { name: 'exercise_logs', userCol: 'user_id' },
  { name: 'food_logs', userCol: 'user_id' },
  { name: 'fasting_logs', userCol: 'user_id' },
  { name: 'user_supplements', userCol: 'user_id' },
  { name: 'emotional_checkins', userCol: 'user_id' },
  { name: 'mind_sessions', userCol: 'user_id' },
  { name: 'padecimientos', userCol: 'user_id' },
  { name: 'medications', userCol: 'user_id' },
  { name: 'user_symptoms', userCol: 'user_id' },
  { name: 'functional_dx', userCol: 'user_id' },
