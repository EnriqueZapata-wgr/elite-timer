...
| Elite | El programa ATP Elite Diagnostics (brochure 2026): sangre a fondo, secuenciación de ADN, sensor de glucosa 14 días, composición corporal y pruebas físicas, entrevista, cuestionarios y química cerebral; kit de manuales (qué comer, qué suplementar con dosis y horario, cómo entrenar y descansar; guía breve y completa); plataforma con ARGOS 12 meses (expediente vivo: Mis Resultados, Mis Cruces, Mi Plan, Evolución, ARGOS IA). En 3.0 el expediente vivo ES la app: la evaluación se entrega dentro como add-on sobre Pro con 12 meses de Pro incluidos; la evaluación queda para siempre aunque Pro venza | 44,970 MXN (hasta 9 MSI) o 38,200 por transferencia (15% menos); más IVA con factura; no incluye suplementos. Revisión cada 6 o 12 meses: 23,450 o 19,930 por transferencia. Add-on Oncogenética: 18,900 | Solo venta personal de Enrique; se activa con código Elite; cada revisión es una versión nueva de la evaluación y un código de renovación |
...
Mapa del brochure a la app 3.0: "Mis Resultados" = Laboratorios y Edad ATP; "Mis Cruces" = Mi evaluación Elite (secciones cruces, sistemas, contexto, genética, química cerebral, composición); "Mi Plan" = Suplementos con plan asignado, Cocina y la sección alimentación y entrenamiento de la evaluación; "Evolución" = comparación de estudios en el tiempo y versiones de la evaluación; "ARGOS IA" = ARGOS con el contexto de la evaluación. El sensor de glucosa de 14 días entra por el módulo Glucosa que ya existe. Lo que el brochure promete "en somosatp.com/tunombre" se cumple en la app; una vista web del expediente queda fuera de 3.0.

Tres cosas del brochure que hay que ajustar (Enrique): (1) Mariana Doria aparece como coautora, contacto y en la sesión de Oncogenética, y hoy es quien hace toda la interpretación genética. Decisión de Enrique (4 de septiembre): va a intentar convencerla de colaborar como proveedora de la parte genética (con regalías o pago por caso); si no, se busca otro proveedor de interpretación genética. La app es agnóstica: la sección `genetica` del `elite_v3` lleva un campo `interpretado_por` y nada más cambia. Mientras se resuelve, Elite se puede seguir vendiendo porque la genética se entrega en la semana 8 (Entrega 2), no en la Entrega 1; (2) el copy usa "diagnóstico", "medicina de precisión", "diagnóstico completo" y "trabajo clínico real revisado por expertos": como servicio persona a persona vendido a pocos clientes el riesgo es menor que en la app, pero una persona física sin cédula que vende "medicina" es tema de ejercicio profesional; conviene "evaluación integral" y "equipo con validación clínica" en la siguiente versión; (3) los precios del brochure son "más IVA con factura", así que el modelo de costos de Elite debe tratarlos como base sin IVA y sumar el costo de laboratorio, ADN, sensor y composición corporal, que hoy no está medido.
...
1. Elite: **integrado el brochure ATP Elite Diagnostics 2026** (ver 1.3): 44,970 con 9 MSI o 38,200 por transferencia, más IVA con factura; incluye 12 meses de plataforma con ARGOS, que en 3.0 son 12 meses de Pro dentro de la app; revisiones a 23,450 o 19,930; Oncogenética 18,900 aparte. Pendiente de Enrique: versión del brochure sin Mariana y con el copy ajustado.
