...
Tres cosas del brochure que hay que ajustar (Enrique): (1) Mariana Doria aparece como coautora, contacto y en la sesión de Oncogenética; el brochure necesita versión 2026-B sin ella o con un validador clínico contratado en su lugar; (2) el copy usa "diagnóstico", "medicina de precisión", "diagnóstico completo" y "trabajo clínico real revisado por expertos": como servicio persona a persona vendido a pocos clientes el riesgo es menor que en la app, pero una persona física sin cédula que vende "medicina" es tema de ejercicio profesional; conviene "evaluación integral" y "equipo con validación clínica" en la siguiente versión; (3) los precios del brochure son "más IVA con factura", así que el modelo de costos de Elite debe tratarlos como base sin IVA y sumar el costo de laboratorio, ADN, sensor y composición corporal, que hoy no está medido.
