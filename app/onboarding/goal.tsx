...
const QUESTIONS: OnboardingQuestion[] = [
  {
    ...
    type: 'single_select',
    options: [
      { id: 'energy', text: 'Tener más energía y rendimiento', icon: 'flash-outline' },
      { id: 'fat_loss', text: 'Perder grasa y mejorar composición', icon: 'body-outline' },
      { id: 'stress', text: 'Reducir estrés y dormir mejor', icon: 'moon-outline' },
  ...
  {
    id: 'attempts',
    text: '¿Qué has intentado antes?',
    subtitle: 'Selecciona todas las que apliquen',
    type: 'multi_select',
    options: [
      { id: 'diets', text: 'Dietas restrictivas' },
      { id: 'apps', text: 'Apps de fitness o nutrición' },
      { id: 'coaching', text: 'Coaching o nutriólogo' },
      { id: 'fasting', text: 'Ayuno intermitente' },
      { id: 'supplements', text: 'Suplementación' },
