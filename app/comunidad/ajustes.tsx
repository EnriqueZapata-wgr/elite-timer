/**
 * TRIBU › MI PERFIL PÚBLICO — visibilidad granular del perfil público +
 * username + bridge Skool. Persiste en user_profile_public (mig 177) al momento.
 * Doctrina: cero chat privado; la conversación humana sale a Skool.
 *
 * SIMPLE (17-ago-2026): vivía en /settings/comunidad. Se movió a Tribu porque
 * quién te ve en la comunidad es una decisión que se toma mirando la comunidad,
 * no hurgando en Ajustes. La ruta vieja quedó como redirect por los deep links.
 */
