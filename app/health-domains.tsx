...
export default function HealthDomainsScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000', justifyContent: 'center', alignItems: 'center', padding: 40 }}>
      ...
      <Ionicons name="grid-outline" size={48} color="#1D9E75" />
      <Text style={{ color: '#fff', fontSize: 20, fontWeight: '800', marginTop: 16 }}>Dominios de salud</Text>
