/**
 * Mi Cronotipo — la vista de TU cronotipo, no el test crudo.
 *
 * Ola 4, pieza 5: se mudó de /my-chronotype a /tests/resultado/cronotipo, que
 * es la ruta que el registry declara como resultado del cronotipo. La ruta
 * vieja queda redirigiendo aquí.
 *
 * La card CRONOTIPO de YO llegaba directo al test aunque el user ya
