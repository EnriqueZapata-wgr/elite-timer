...
// MB-27 1.2, corregido en audit B6: la elección de peso ya no es por tabla
// sino por MEDICIÓN MÁS RECIENTE — vive en cuerpo/medidas-core
// (pesoMasReciente), compartida con health-score-service.
