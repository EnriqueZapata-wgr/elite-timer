...
export const INTERVENTIONS_CATALOG: Intervention[] = [
  ...
  },
  {
    ...
    name: 'Exposición solar matutina (7-9am)',
    how: 'Sal a luz solar directa entre 7-9am, ojos abiertos sin lentes de sol. Minutos según tu fototipo: piel clara 5-10 min, piel media 10-15, piel oscura 15-20.',
    ...
    assignRule: 'Universal — dosis adaptada por fototipo Fitzpatrick (piel clara menos minutos, piel oscura más). Reforzar en insomnio de conciliación, fatiga matutina, vitamina D baja.',
    priority: 1,
    isUniversal: true,
    timeOfDay: 'morning',
    evidenceLevel: 'N2',
  ...
  {
    // Confirmada como universal por Enrique (dx-f3).
    ...
    assignRule: 'Universal — reforzar en insomnio de conciliación.',
    priority: 1,
    isUniversal: true,
    timeOfDay: 'night',
  },
  {
    ...
    how: 'Contacto directo de pies descalzos con tierra o pasto, 10-15 min continuos.',
    benefit: 'Reduce carga inflamatoria y estrés; reconecta el sistema nervioso con señales de calma y recarga energía.',
    categories: ['inflamacion', 'energia'],
    roots: ['inflamacion_silenciosa', 'estres_cronico'],
  ...
  },
  {
    ...
    name: 'Respiración nocturna 5 min',
    how: 'Respiración 4-7-8 o diafragmática durante 5 min antes de dormir.',
    benefit: 'Activa el parasimpático, baja la adrenalina nocturna y facilita conciliar el sueño.',
    categories: ['sueno', 'ritual'],
    roots: ['adrenalina_nocturna', 'estres_cronico', 'deficit_sueno_profundo'],
