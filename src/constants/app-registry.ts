...
/** Niveles que pueden cerrar una app. Free nunca cierra nada. */
export type MinTier = 'premium' | 'elite';
...
export interface AppEntry {
  ...
  femaleOnly?: boolean;
  /**
   * ATP 3.0 (5-sep-2026, matriz 3.2 del pivote): nivel mínimo que abre la app.
   * Sin valor = abierta para Free. Lo bloqueado SE VE con candado, nunca
   * desaparece (regla 15 de la casa): `visibleApps` lo marca, no lo filtra.
   * A quien pagó no se le corta nada: premium abre todo lo `premium`.
   */
  minTier?: MinTier;
...
export const APP_REGISTRY: AppEntry[] = [
  // ── Mente ──
  { key: 'meditar', label: 'Meditar', icon: 'meditar', section: 'mente', route: '/meditation', installable: true, minTier: 'premium', alias: ['meditación', 'nsdr', 'calma'],
  ...
  { key: 'emociones', label: 'Emociones', icon: 'emociones', section: 'mente', route: '/emotions', installable: true, minTier: 'premium', alias: ['check-in', 'ánimo', 'humor', 'sentir'],
  ...
  { key: 'sueno', label: 'Sueño', icon: 'sueno', section: 'mente', route: '/sleep', installable: true, minTier: 'premium', alias: ['dormir', 'descanso', 'noche'],
    description: 'Tu ventana de sueño ideal según tu cronotipo, y el estado honesto de tus fuentes de descanso.' },
  { key: 'nback', label: 'N-Back', icon: 'nback', section: 'mente', route: '/mente/nback', installable: true, minTier: 'premium', alias: ['memoria', 'cognición', 'juego', 'atención'],
  ...
  // la pestaña Rachas.
  { key: 'rachas', label: 'Rachas', icon: 'rachas', section: 'mente', route: '/reports/adherencia?tab=rachas', installable: false, minTier: 'premium', alias: ['progreso', 'medallas', 'constancia', 'racha'],
    description: 'Tus rachas de journal, respiración, meditación y check-in, con medallas de 7, 30, 90 y 365 días.' },

  // ── Cuerpo ──
  { key: 'entrenar', label: 'Entrenar', icon: 'entrenar', section: 'cuerpo', route: '/fitness-hub', installable: true, minTier: 'premium', alias: ['fitness', 'rutina', 'gym', 'fuerza', 'hiit'],
  ...
  { key: 'rm', label: '1RM', icon: 'rm', section: 'cuerpo', route: '/log-strength', installable: false, minTier: 'premium', alias: ['levantamiento', 'registrar', 'series', 'barra'],
    description: 'Registra tus series de fuerza con peso y repeticiones, con cálculo de tu máximo (1RM) en vivo.' },
  { key: 'records', label: 'Récords', icon: 'records', section: 'cuerpo', route: '/fitness-strength', installable: false, minTier: 'premium', alias: ['pr', 'benchmarks', 'marcas'],
  ...
  { key: 'suplementos', label: 'Suplementos', icon: 'suplementos', section: 'diario', route: '/supplements', installable: true, minTier: 'premium', alias: ['pastillas', 'vitaminas', 'magnesio'],
  ...
  { key: 'recetas', label: 'Recetas', icon: 'recetas', section: 'diario', route: '/cocina?tab=recetas', installable: false, minTier: 'premium', alias: ['cocinar', 'platillos', 'menú'],
    description: 'Guarda tus comidas como recetas y reúsalas al registrar, sin volver a capturar nada.' },
  // 22-ago-2026: la lista dejó de ser la pantalla y pasó a ser una sección.
  // Lo que la persona viene a hacer aquí es el súper completo: leer etiquetas
  // con la cámara y saber elegir. La llave se queda por los enlaces existentes.
  { key: 'lista-compra', label: 'Súper', icon: 'lista-compra', section: 'diario', route: '/cocina?tab=lista', installable: false, minTier: 'premium', alias: ['compras', 'lista', 'mandado', 'despensa', 'etiquetas', 'etiqueta', 'sellos', 'ingredientes'],
    description: 'Hacer el súper con criterio: lee una etiqueta con la cámara y te decimos qué sellos le tocan y qué trae su lista de ingredientes. Aquí vive también tu lista de compras.' },
  ...
  { key: 'glucosa', label: 'Glucosa', icon: 'glucosa', section: 'salud', route: '/glucose-log', installable: true, minTier: 'premium', alias: ['azúcar', 'cgm', 'glicemia'],
    description: 'Registra tu glucosa con contexto (ayunas, antes o después de comer) y ve tu historial con rangos visuales.' },
  { key: 'cetonas', label: 'Cetonas', icon: 'cetonas', section: 'salud', route: '/ketones-log', installable: true, minTier: 'premium', alias: ['keto', 'cetosis'],
  ...
  { key: 'sintomas', label: 'Síntomas', icon: 'sintomas', section: 'salud', route: '/salud/mis-sintomas', installable: false, minTier: 'premium', alias: ['malestar', 'dolor', 'molestias'],
  ...
  { key: 'mapa-funcional', label: 'Mi mapa', icon: 'diagnostico', section: 'salud', route: '/salud/diagnostico', installable: false, minTier: 'premium', alias: ['mapa funcional', 'raíces', 'sistemas'],
  ...
  { key: 'reportes', label: 'Reportes', icon: 'reportes', section: 'salud', route: '/reports', installable: false, minTier: 'premium', alias: ['reporte', 'semana', 'consulta', 'estadísticas'],
  ...
  { key: 'cronotipo', label: 'Cronotipo', icon: 'cronotipo', section: 'salud', route: '/my-chronotype', installable: false, minTier: 'premium', alias: ['reloj', 'ritmo', 'horarios'],
    description: 'Tu cronotipo con tu ventana real de despertar y dormir, y a qué horas rinde tu cuerpo según tu reloj interno.' },
  { key: 'historia-clinica', label: 'Historia', icon: 'historia-clinica', section: 'salud', route: '/historia-clinica', installable: false, minTier: 'premium', alias: ['antecedentes', 'historial', 'expediente'],
...
/** Orden de los peldaños para comparar niveles. Duplica el de tier-logic a propósito: este archivo es un registro y no importa lógica. */
const RANGO_NIVEL: Record<Tier, number> = { free: 0, premium: 1, elite: 2 };

/**
 * ATP 3.0: ¿este nivel abre una app con este mínimo? Función pura para que el
...
/** Una entrada del registro ya evaluada contra el nivel de quien la mira. */
 ...
 *
 * ATP 3.0 (5-sep-2026): además de filtrar `femaleOnly`, devuelve cada entrada
 * con `bloqueada` según `minTier` y el nivel. NO oculta nada por nivel: lo
 * bloqueado se ve con candado (regla 15). `tieneEvaluacionElite` abre lo que
 * exige `elite` aunque el tier ya no lo sea: la evaluación se enciende por
 * existencia, no por vigencia (pivote 2.3.3, dato del usuario sagrado).
 * Los llamadores viejos siguen funcionando: sin nivel se asume `free`.
 */
