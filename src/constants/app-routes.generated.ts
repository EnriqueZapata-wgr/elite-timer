...
export const APP_ROUTES: readonly string[] = [
  ...
  "/perfil",
  "/plan-entrenamiento",
  "/primera-sesion/armado",
  "/primera-sesion/dia-1",
  "/primera-sesion/objetivo",
...
export const APP_ROUTE_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  "/argos": "Tab ARGOS — el hub (HUB-ARGOS, 31-ago-2026; pendiente 13.1). Antes este archivo re-exportaba el chat: tocar la orbe caía directo a la",
  ...
  "/edad-atp/comparar": "Comparar estudios en el tiempo (ATP 3.0, 6-sep-2026, ruta 2.5). Dos fechas de estudio, y marcador por marcador: el valor en cada una, la",
  ...
  "/elite": "ATP Elite: la página dentro de la app (ATP 3.0, 6-sep-2026, ruta 3.4 y 3.8; la ruta `RUTA_ELITE` la definió la ola 1 para que los candados Elite ya",
  ...
  "/fitness-cardio": "Tu perfil de cardio: zonas de frecuencia cardiaca, VO2max estimado y tu semana. Desde aquí registras sesiones a mano o las importas de tu app de salud.",
  ...
  "/food-preferences": "Preferencias de comida — redirect (OLA3 · Anexo D §1). Es la pestaña Preferencias de /cocina, al lado de su único consumidor: el",
  ...
  "/history": "Historial de Sesiones — Lista cronológica de workout_sessions agrupada por fecha, con cards premium por modo (rutina/manual).",
  ...
  "/primera-sesion/armado": "Primera sesión · pantalla 4 de 6 — LA APP SE ARMA ENFRENTE. Pivote limpio, 7 de septiembre de 2026 (sección 6 del plan).",
  "/primera-sesion/dia-1": "Primera sesión · pantalla 6 de 6 — TU DÍA 1. Pivote limpio, 7 de septiembre de 2026 (sección 6 del plan).",
  "/primera-sesion/objetivo": "Primera sesión · pantalla 3 de 6 — TU OBJETIVO. Pivote limpio, 7 de septiembre de 2026 (sección 6 del plan).",
  ...
  "/redeem-code": "TENGO UN CÓDIGO — canje de códigos de activación (MB-13 · PIEZA 1). Para servicios contratados con ATP (Founders, Elite), el invitado o la",
  ...
  "/salud/evaluacion-elite": "Mi evaluación Elite (ATP 3.0, 6-sep-2026, ruta 3.3 y 3.10). El entregable de Enrique (formato Omar, esquema `elite_v3`) navegable dentro",
  ...
  "/salud/genetica": "Genética (ATP 3.0, 6-sep-2026, ruta 3.4). Se enciende por EXISTENCIA de una evaluación Elite con hallazgos genéticos",
  ...
  "/salud/intervenciones": "/salud/intervenciones: RETIRADA A REDIRECT (pivote limpio, 7-sep-2026, decisión del dueño).",
  "/salud/intervenciones/rationale": "¿POR QUÉ ESTAS PRÁCTICAS? — narrativa ARGOS (Megabuzón 2da pasada B.4). 7-sep-2026 (pivote limpio): su puerta era la lista \"Mi Protocolo\", que se",
  ...
  "/settings/comunidad": "Redirect. Los ajustes de comunidad se mudaron a /comunidad/ajustes (Tribu). El archivo se queda como stub y no se borra porque esta ruta es un deep link",
  ...
  "/settings/cuenta": "Redirect. \"Perfil y cuenta\" se disolvió en el hub de Ajustes. Tenía tres destinos reales (editar perfil, suscripción, cerrar sesión) y una",
  ...
  "/supplements/historial": "Suplementos: historial y adherencia (backlog 3.6, 10.5 y 10.6). Los ultimos 30 dias agrupados por dia, la adherencia del PLAN a 7 y 30",
