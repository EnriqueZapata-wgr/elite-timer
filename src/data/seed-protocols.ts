...
export const ACTION_BLOCKS = [
  {
    ...
    actions: [
      ...
      { name: 'Suplementos AM', category: 'optimization', time_offset_min: 17, duration_min: 2, instructions: 'Registra tus suplementos de la mañana', link_type: null },
  ...
  },
  {
    ...
    actions: [
      ...
      { name: 'Suplementos PM', category: 'optimization', time_offset_min: 5, duration_min: 2, instructions: 'Registra tus suplementos de la noche', link_type: null },
  ...
  },
  {
    ...
    color: '#EF9F27',
    actions: [
      { name: 'Suplementos AM', category: 'optimization', time_offset_min: 0, duration_min: 2, instructions: 'Registra tus suplementos de la mañana', link_type: null },
      ...
      { name: 'Suplementos PM', category: 'optimization', time_offset_min: 720, duration_min: 2, instructions: 'Registra tus suplementos de la noche', link_type: null },
    ],
  },
  {
...
export const PROTOCOL_TEMPLATES = [
  {
    ...
    default_actions: [
      ...
      { name: 'Suplementos AM', category: 'optimization', default_time: '07:15', duration_min: 2, instructions: 'Registra tus suplementos de la mañana', chronotype_offsets: { lion: -60, bear: 0, wolf: 90, dolphin: 0 }, phase: null },
      ...
      { name: 'Suplementos PM', category: 'optimization', default_time: '22:15', duration_min: 2, instructions: 'Registra tus suplementos de la noche', chronotype_offsets: { lion: -30, bear: 0, wolf: 60, dolphin: 0 }, phase: null },
  ...
  },
  {
    ...
    default_actions: [
      ...
      { name: 'Suplementos AM', category: 'optimization', default_time: '07:20', duration_min: 2, instructions: 'Registra tus suplementos de la mañana', chronotype_offsets: { lion: -60, bear: 0, wolf: 90, dolphin: 0 }, phase: null },
  ...
  },
  {
    ...
    default_actions: [
      ...
      { name: 'Suplementos noche', category: 'optimization', default_time: '21:30', duration_min: 2, instructions: 'Registra tus suplementos de la noche', chronotype_offsets: { lion: -30, bear: 0, wolf: 60, dolphin: 0 }, phase: null },
  ...
  },
  {
    ...
    default_actions: [
      ...
      { name: 'Suplementos con la comida', category: 'optimization', default_time: '19:45', duration_min: 2, instructions: 'Registra tus suplementos con la comida', chronotype_offsets: { lion: -60, bear: 0, wolf: 60, dolphin: 0 }, phase: 2 },
